...
<%
    Marque[] marques = (Marque[]) request.getAttribute("marque");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main">
        ...
        <div class="table-main" id="form-table">
            <div class="form-table">
                <form action="<%=request.getContextPath()%>/admin/marque/addMarque" class="formulaire" method="post" modelAttribute="marque">
        ...
        <div class="table-main">
            <table>
                ...
                <tr>
                    <form method="post" action="<%=request.getContextPath()%>/admin/marque/modifier" modelAttribute="marque">
                        <input type="hidden" name="id" value="<%=marque.getId()%>"/>
                        <td><input type="text" name="nom" value="<%=marque.getNom()%>"/></td>
                        <td><button type="submit">modifier</button> </td>
                    </form>
                    <td><a href="<%=request.getContextPath()%>/admin/marque/models?id=<%=marque.getId()%>">models</a> </td>
                    <td><a href="<%=request.getContextPath()%>/admin/marque/delete?id=<%=marque.getId()%>"><button type="button">supprimer</button> </a> </td>
                </tr>
                <%}%>
            </table>
        </div>
